...
import ArrowRight from "../../assets/icons/arrow-right-2.svg?react";
  ...
  return (
    ...
    >
      <div className={`flex flex-col md:flex-row items-center justify-between py-10 px-5 
        md:px-10 lg:px-24 bg-[#FAFAFA] ${index !== "04" ? 'border-b-2 border-[var(--tertiary-color)]' : ''}`}>
        <div className="w-full flex flex-col md:flex-row items-center md:gap-3 lg:gap-10">
          ...
          <div className="flex flex-col md:flex-row items-center gap-6 md:gap-10">
            ...
            <div className="flex items-center gap-3 lg:gap-8">
              <h3 className="sora text-2xl md:text-3xl lg:text-5xl">{title}</h3>
